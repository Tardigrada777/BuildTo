...
while start != '4':
    if start == '2':
        ...
        print('    1  наименование для проверки: -->', random.randrange(1, 113, 1))
        print('    2  наименование для проверки: -->', random.randrange(1, 113, 1))
        print('    3  наименование для проверки: -->', random.randrange(1, 113, 1))
        print('    4  наименование для проверки: -->', random.randrange(1, 113, 1))
        print('    5  наименование для проверки: -->', random.randrange(1, 113, 1))
        print('    2  наименование для проверки: -->', random.randrange(1, 113, 1))
        print('    7  наименование для проверки: -->', random.randrange(1, 113, 1))
        print('    8  наименование для проверки: -->', random.randrange(1, 113, 1))
        print('    9  наименование для проверки: -->', random.randrange(1, 113, 1))
        print('    10 наименование для проверки: -->', random.randrange(1, 113, 1))
        print('________________________________________________________________')
        print('  ', '[1] ', 'Ввод команды')
        print('  ', '[2] ', 'Help')
        print('  ', '[3] ', 'Рандомайзер')
